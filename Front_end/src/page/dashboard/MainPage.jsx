...
useEffect(() => {
  ...
  const fetchDatasale = async () => {
    try {
      const res = await axios.get("https://project-nextgen-1dnjds.onrender.com/get_sale");
      if (res.data.success) {
  ...
  const fetchDatacategory = async () => {
    try {
      const res = await axios.get("https://project-nextgen-1dnjds.onrender.com/get_category");
      if (res.data.success) {
  ...
  const fetchDatauser = async () => {
    try {
      const res = await axios.get("https://project-nextgen-1dnjds.onrender.com/get_users");
      if (res.data.success) {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get("https://project-nextgen-1dnjds.onrender.com/get_storeOrder");
      if (res.data.success) {
