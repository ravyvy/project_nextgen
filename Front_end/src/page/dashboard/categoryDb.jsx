  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        ...
        await axios.post(
          `https://project-nextgen-1dnjds.onrender.com/edit/${currentProduct.id}`,
          formData,
              ...
              currentItems.map((p) => (
                <tr key={p?.id || Math.random()} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-3">
                    {p?.img && (
                      <img
                        src={`https://project-nextgen-1dnjds.onrender.com/images/${p.img}`}
                        alt="main"
                  ...
                  <td className="p-3">
                    {p?.imgone && (
                      <img
                        src={`https://project-nextgen-1dnjds.onrender.com/images/${p.imgone}`}
                        alt="hover 1"
                        className="w-16 h-16 object-cover rounded shadow-sm mx-auto"
                        onError={(e) => (e.target.src = "/placeholder-image.png")}
                      />
                  ...
                  <td className="p-3">
                    {p?.imgtwo && (
                      <img
                        src={`https://project-nextgen-1dnjds.onrender.com/images/${p.imgtwo}`}
                        alt="hover 2"
                        className="w-16 h-16 object-cover rounded shadow-sm mx-auto"
                        onError={(e) => (e.target.src = "/placeholder-image.png")}
                      />
